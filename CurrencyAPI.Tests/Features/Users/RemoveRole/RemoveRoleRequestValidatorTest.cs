...
public class RemoveRoleRequestValidatorTest
{
    [Theory]
    ...
    {
        var validator = new RemoveRoleRequestValidator();
        var request = new RemoveRoleRequest { UserId = userId, Role = (CurrencyApp.Data.Entities.UserRole)role };
